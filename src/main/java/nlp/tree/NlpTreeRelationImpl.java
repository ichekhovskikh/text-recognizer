...
public class NlpTreeRelationImpl implements NlpTreeRelation {
    private String tag;
    private List<NlpTreeObject> heads;
    private List<NlpTreeObject> dependents;

    public NlpTreeRelationImpl() {
        heads = new ArrayList<>();
        dependents = new ArrayList<>();
    }

    public NlpTreeRelationImpl(String tag) {
        this.tag = tag;
        heads = new ArrayList<>();
        dependents = new ArrayList<>();
    }

    public NlpTreeRelationImpl(String tag, List<NlpTreeObject> heads, List<NlpTreeObject> dependents) {
        this.tag = tag;
        this.heads = heads;
    ...
    public boolean equals(Object obj) {
        ...
        return this.tag.equals(nlpTreeRelation.getTag());
    }
}
